...
function ckstyle() { //定义总的风格
	...
	*/
	advmarquee:escape('{a href="http://www.ckplayer.com"}{font color="#FFFFFF" size="12"}Fingers on the robot hand were driven by three motors inside the palm. This dexterous hand was controlled by data gathered from the feedback of force sensors, coded disc, and etc. It can also controlled by the software we programmed on the computer. In this case, this dexterous can grasp objects accurately.{/font}{/a}'),
	/*
